...
<!---                        <div class="col-sm-3 label-div">
                        ...
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} MO</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_mo || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_mo">{{ fovCtrl.data.alt.office_hours_mo }}</p>			
                        </div>	
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} TU</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_tu || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_tu">{{ fovCtrl.data.alt.office_hours_tu }}</p>			
                        </div>	                    
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} WE</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_we || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_we">{{ fovCtrl.data.alt.office_hours_we }}</p>			
                        </div>	                    
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} TH</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_th || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_th">{{ fovCtrl.data.alt.office_hours_th }}</p>			
                        </div>	 
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} FR</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_fr || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_fr">{{ fovCtrl.data.alt.office_hours_fr }}</p>			
                        </div>	 
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} SA</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_sa || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_sa">{{ fovCtrl.data.alt.office_hours_sa }}</p>			
                        </div>	                     
                        
                        <div class="col-sm-3 label-div">
                            <span class="label label-primary">{{ fovCtrl.lib.BUSINESS_HOURS }} SU</span> 
                        </div>
                        <div class="col-sm-9 item-div">	                    
                            <span class="current-data">{{fovCtrl.data.office_hours_su || 'Required'}}</span>	
                            <p class="alt-data" ng-if="fovCtrl.data.alt.office_hours_su">{{ fovCtrl.data.alt.office_hours_su }}</p>			
                        </div>   
